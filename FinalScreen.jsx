...
export default function FinalMessageScreen() {
  ...
  const messages = [
    ...
    "From that first message to now it already feels like something special is growing",
    "We may not have old memories yet but every smile we share is a step towards them. 😊💖",
    "I don’t know where this journey will lead,but I’m sure — it’s gonna be beautiful. ✨,
    "So here’s to new bonds,to laughs we haven’t laughed yet,and to moments we’ll never forget... 🫶",
    "Happy Friendship Day, my dear Best friend! 💖 HONEY..!!",
  ]
